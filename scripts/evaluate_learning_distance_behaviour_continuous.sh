...
EXPERIMENT_TYPE=learning_based_distance_behaviour
...
for ORDER_ARRIVAL_INTERVAL in ${ORDER_ARRIVAL_INTERVAL_LIST[*]}; do
	...
	for S_DECENTRALISED_LEARNING_DISTANCE in ${NUMBER_OF_ROBOTS_LIST[*]}; do
		...
		for EXPLORATION_PROBABILITY in ${EXPLORATION_PROBABILITY_LIST[*]}; do
			...
			JOB_PARAM="S${S_DECENTRALISED_LEARNING_DISTANCE}_WORKING_THRESH_${WORKING_THRESH}_MINBH_${MIN_BH}_ORDER_ARRIVAL_AVERAGE${ORDER_ARRIVAL_INTERVAL}_EXPLORATION_PROBABILITY_${EXPLORATION_PROBABILITY}"
